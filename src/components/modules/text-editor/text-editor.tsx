...
import { EditorInstance } from '@components/modules/text-editor/instance';
import { plugins } from '@components/modules/text-editor/plugins';
import { useTranslation } from 'react-i18next';
import { OutputData } from '@editorjs/editorjs';
import { EditorCore } from '@react-editor-js/core/src/editor-core';
import { cn } from '@lib/utils/tools';
import { withHeadingTemplate } from '@components/modules/text-editor/templates';
